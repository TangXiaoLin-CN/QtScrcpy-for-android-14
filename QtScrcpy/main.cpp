...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    // Single instance check - must keep server alive
    static QTcpServer *singleInstanceServer = new QTcpServer();
    if (!singleInstanceServer->listen(QHostAddress::LocalHost, 29318)) {
        QMessageBox::warning(nullptr, "QtScrcpy", "QtScrcpy is already running!");
        return 0;
    }
